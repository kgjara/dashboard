...
export default function ControlPanel() {
    ...
    return (
        ...
        /*Renderizacion JSX (desde la inicializacion)

        Manejador de eventos +UseRef (Cada vez que se lance el evento)

        Es mejor por:
        1. Para optimizar poder de computo
        2.Mayor escalabilidad, porque no tiene que buscar donde cambia el jsx
        */
    )
}